...
import { roundValue, sleep } from "../functions/shared";
...
export async function setHardwareValues(slottype, slot, channel, value, delay) {
  const params = {
  ...
  const result =  await invoke('write_adam', params);
